 ...
 */
Code.TABS_ = [
  'blocks', 'preview', 'html_fragment', 'javascript','xml', 'json'
];
 ...
 */
Code.TABS_DISPLAY_ = [
  'Blocks', 'Preview' ,'HTML-Fragment', 'JavaScript', 'PHP', 'Python', 'Dart', 'Lua', 'XML', 'JSON'
];
...
Code.previewHTML = function(generator) {
  ...
  if (Code.checkAllGeneratorFunctionsDefined(generator)) {
    var code = generator.workspaceToCode(Code.workspace);
    document.querySelector("#previewIframe").srcDoc = "<h1>hi</h1>";
...
document.write('<script src="msg.js"></script>\n');
